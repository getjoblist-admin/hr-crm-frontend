...
async function fetchCandidate() {
  ...
  document.getElementById("candidateUI").classList.remove("d-none");

  document.getElementById("candName").innerText = res.name;
  document.getElementById("candMobile").innerText = res.mobile;
}
